...
import { BookOpen, Building2, ChartBar, ClipboardCheck, Database, FileSpreadsheet, HardDrive, Home, Info, LayoutDashboard, Layers, LoaderCircle, LogIn, LogOut, Newspaper, Shield, TrendingUp } from "lucide-react";
