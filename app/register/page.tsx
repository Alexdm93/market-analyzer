...
export default function RegisterPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden px-6 py-8 md:px-10 md:py-10">
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl items-center gap-8 lg:grid-cols-[24rem_minmax(0,1.1fr)]">
        <section className="surface-card rounded-[2rem] p-6 md:p-8 lg:order-2">
          <div className="eyebrow mb-2">Registro</div>
          <h1 className="font-display text-3xl font-bold text-slate-900">Crear cuenta</h1>
        ...
        <section className="surface-panel rounded-[2rem] p-8 md:p-10 lg:order-1">
          <div className="eyebrow mb-3">Usuarios internos</div>
          <h2 className="font-display max-w-2xl text-4xl font-bold tracking-tight text-slate-900 md:text-5xl">
